...
import requests                         #Request for APIs
from datetime import datetime, date     #Converting dates and applying arithmetic
import json                             #Read json
from twilio.rest import Client          #Used for sms alert
                ...
                for x in range(len(y['data'])):
                    ...
                    #Phone notification!
                        ...
                        #Auth Token from twilio.com/console
                            auth_token = '6b27801cb3ea180699c3e73408d449db' 
